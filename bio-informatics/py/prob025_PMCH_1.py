...
def proc_fasta_map(fasta_map):
    ...
    vec_string = list(fasta_map[0]["string"])
    return factorial(vec_string.count("A")) * factorial(vec_string.count("C"))
...
AGCUAGUCAU"""
    ...
    output(proc_fasta_map(gentools.collect_from_FASTA(sample_dataset)))
