...
if(cljs.core.truth_((function (){var and__5043__auto__ = (!(((cljs.core.count(acc) - (i + (1))) === (0))));
...
var G__20984 = nel;
var G__20985 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,nel);
cel = G__20984;
acc = G__20985;
continue;
} else {
