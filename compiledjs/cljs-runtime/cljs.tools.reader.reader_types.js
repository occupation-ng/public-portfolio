...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11427 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11427(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11428 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11428(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11429 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11429(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11432 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11432(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11433 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11433(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11437 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11437(reader);
}
});
...
var G__11456 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11457 = s.append(c);
c = G__11456;
s = G__11457;
continue;
}
