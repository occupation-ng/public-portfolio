...
var or__5045__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469).cljs$core$IFn$_invoke$arity$1(m),s);
...
if((i__$1 > (0))){
var G__20876 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__20876;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__5043__auto__ = id;
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m_QMARK_,(cljs.core.truth_(id)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),id], null):null),(cljs.core.truth_(cs)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var temp__5802__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(m_QMARK_);
...
(hipo.hiccup.Sentinel.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"hipo.hiccup/Sentinel");
}));
...
while(true){
if(cljs.core.seq(s)){
var G__20907 = (function (){var f = cljs.core.first(s);
...
var G__20909 = ((cljs.core.seq_QMARK_(f))?hipo.hiccup.conjs_BANG_(acc,f):(((!((f == null))))?cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,f):acc
));
var G__20910 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(v__$1,(1));
acc = G__20909;
v__$1 = G__20910;
continue;
}
